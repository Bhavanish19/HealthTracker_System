...
$dbhandle=new mysqli('localhost','root','','health_tracker');
		...
		<div class="top-area">
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-6 col-md-6">
					<p class="bold text-right">Call us now +91 9899918356</p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-sm-6 col-md-4">
					...
					<div class="widget">
						...
						<p>
						It is the best place to get the treatment.
						</p>
					</div>
					</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-6 col-md-6 col-lg-6">
					...
					<div class="text-left">
					<p>&copy;Copyright 2019 - Health Tracker. All rights reserved.</p>
					</div>
					</div>
				</div>
			</div>	
